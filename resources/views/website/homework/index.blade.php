                ...
                <table  class="display table  table-bordered   table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="diagonal app_font h3 text-center" >تحميل الواجب </th>
                            <th class="diagonal app_font h3 text-center">حل الواجب</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="app_font h3 text-center">
                                ...
                                <a class="app_font text-center btn btn-success btn_homework" href="{{route('student.homework.show',$homework->id)}}">
                                    رؤية الواجب
                                </a>
                            </td>
                            <td class="app_font h3 text-center">
                                <a class="app_font text-center btn btn-success btn_homework" href="{{route('student.homework.download',$homework->id)}}">
                                  تحميل الواجب
                              </a>
                          </td>
                          <td class="app_font h3 text-center">

                            <a class="app_font text-center btn btn-secondary btn_homework" href="{{route('student.homework.solution',$homework->id)}}">
                                حل الواجب
                            </a>
                        </td>
                        </tr>
