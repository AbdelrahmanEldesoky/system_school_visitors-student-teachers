...
(function (window, document, $) {
  ...
  var basicPickr = $('.flatpickr-basic'),
   ...
   monthPickrArb = $('.flatpickr-month-ar'),
   monthPickrEng = $('.flatpickr-month-en'),
  ...
  if (monthPickrArb.length) {
    monthPickrArb.flatpickr({
      // dateFormat: "M Y d",
      locale: {
        firstDayOfWeek: 1,
        disableMobile: "true",
        ...
        months: {
          shorthand: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'June', 'July', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
          longhand: ['يناير', 'فبراير', 'مارس', 'ابريل', 'مايو', 'يونيو', 'يوليو', 'أغسطس', 'سبتمبر', 'أكتوبر', 'نوفمبر', 'ديسمبر'],
        },
      },
    });
  }
  if (monthPickrEng.length) {
    monthPickrEng.flatpickr({
      // disableMobile: "true",
      // dateFormat: "M Y d",
    });
  }
