...
class SpecialityDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($query){
              return '<div> <a class="add_speciality" href="'.route('admin.specialities.create',$query->id).'" data-name_ar="'.$query->name_ar.'" data-name_en="'.$query->name_en.'" data-image="'.asset($query->image).'"><i class="fa fa-eye"></i></a>
                          <a href="'.route('admin.specialities.destroy',$query->id).'"
                                   class=" delete-btn">
    ...
    protected function getColumns()
    {
        return [
            ...
            ['data' => 'name_en', 'name' => 'name_en', 'title' => 'Name (Eng)', 'orderable' => false],
