...
return [
    ...
    'log_sign'=>"Se connecter/ S'inscrire",
    'privacy_policy'=>'politique de confidentialité',
    'for_doctors' => 'Politique de confidentialité des médecins',

    'phone_mobile' => 'Téléphone /portable',
    'address' => 'Addresse',

    'what_we_are' => 'QUI NOUS SOMMES?',
    ...
    'book_psy' => 'Réservez votre séance maintenant',

    'come_on_search' => 'Choisissez le service psychologique que vous souhaitez obtenir facilement de la manière qui vous convient avec une sélection des meilleurs médecins.',
    'book_doctor' => 'Réservez un médecin',
    'tele_health' => 'Télésanté',
    'book_me' => 'Réservez-moi',
...
'see_more' => 'See More',
'payments_pending_code' => 'Please make the payment process with the following code in order to complete the booking request:',
'Loggedin_successfully' => 'Logged in Successfully',
'pay_valid_text' => 'Kindly ensure that your payment is made within the next two hours, otherwise, we regret to inform you that your appointment will be cancelled.',
