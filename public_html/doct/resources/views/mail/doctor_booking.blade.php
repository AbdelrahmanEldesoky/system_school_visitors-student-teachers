...
<div style="display: none;">Booking Email</div>
                        ...
                        <td class="sm-px-24" style="font-family: 'Montserrat',Arial,sans-serif;" align="center">
                            <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tbody><tr>
                                    ...
                                    <p>You have a new {{$details['type']}} appointment booked.</p>
...
<p>لديك حجز موعد أونلاين جديد</p>
@else
<p>لديك حجز موعد أوفلاين جديد</p>
@endif
<p>
يوم : @lang('site.'.$details['day']) 
    <br>
    {{$details['date']}} : تاريخ  
    <br>
    {{$details['name']}} : إسم المريض  
    <br>
    {{$details['phone']}} : رقم تليفون 
    <br>
