...
<div style="display: none;">Contact Message</div>
                ...
                <table class="sm-w-full" style="font-family: 'Montserrat',Arial,sans-serif; width: 600px;" role="presentation" width="600" cellspacing="0" cellpadding="0">
                    <tbody><tr>
                        <td class="sm-py-32 sm-px-24" style="font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; padding: 48px; text-align: center;" align="center">
                            <a href="#">
                                <img src="{{asset('images/logo.png')}}" alt="Iperosona" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle;" width="155">
                            </a>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tbody><tr>
                                    <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; background-color: rgba(255, 255, 255, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262; color: rgba(98, 98, 98, var(--text-opacity));" bgcolor="rgba(255, 255, 255, var(--bg-opacity))" align="left">
                                        ...
                                        {{$data['name']}}, has sent you a folling query message:
                                        <br>
                                        {!!$data['message']!!}
                                        </p>
                                        <table style="font-family: 'Montserrat',Arial,sans-serif;" role="presentation" cellspacing="0" cellpadding="0">
                                            <tbody><tr>
                                                <td style="mso-padding-alt: 16px 24px; --bg-opacity: 1; background-color: #7367f0; background-color: rgba(115, 103, 240, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;" bgcolor="rgba(115, 103, 240, var(--bg-opacity))">
                                                    <a href="https://ipersona.me/" style="display: block; font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px; --text-opacity: 1; color: #ffffff; color: rgba(255, 255, 255, var(--text-opacity)); text-decoration: none;">Goto Home →</a>
                                                </td>
                                            </tr>
                                            </tbody></table>
                                        <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                        ...
                                        <p style="margin: 0 0 16px;">Thanks, <br>The Ipersona Team</p>
                                    </td>
                                </tr>
                                <tr>
