<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" href="../../../html/ltr/vertical-menu-template/index.html"><span class="brand-logo">
                    ...
                    <h2 class="brand-text">Ipersona</h2>
                </a></li>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{route('hospital.appointments.index')}}">
            ...
            <hr>
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{route('hospital.profile')}}">
